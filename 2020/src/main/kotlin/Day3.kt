 ...
 * might be easy, it's certainly not safe: there's very minimal steering and the area is covered in trees.
 ...
 * .#..#...#.#|.#..#...#.#|.#..#...#.#|.#..#...#.#|.#..#...#.#|.#..#...#.#  --->
 * ```
 * You start on the open square (`.`) in the top-left corner and need to reach the bottom (below the bottom-
 * most row on your map).
 *
 ...
 *
 * *[Open in browser](https://adventofcode.com/2020/day/3)*
 */
object Day3 {
