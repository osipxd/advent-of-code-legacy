 ...
 * The sum of measurements in the second window is larger than the sum of
 ...
 *
 * *[Open in browser](https://adventofcode.com/2021/day/1)*
 */
object Day1 {
    ...
    private fun Sequence<Int>.countIncreases(): Int {
        ...
        for (value in this) {
            if (value > lastMeasurement) increases++
